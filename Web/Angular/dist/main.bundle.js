...
var serverPath = {
    ...
    // Report
    reportStatistic: function (projectId) { return "/api/report/project/" + projectId + "/statistic"; },
    reportProgress: function (projectId) { return "/api/report/project/" + projectId + "/progress"; },
};
...
var ProjectService = /** @class */ (function () {
    ...
    ProjectService.prototype.getAllMethodAdvertising = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            Object(__WEBPACK_IMPORTED_MODULE_2_superagent__["get"])(__WEBPACK_IMPORTED_MODULE_3__serverPath__["a" /* serverPath */].getMethodAdvertisingList)
                .set('token', _this.tokenCursor.get())
                .then(function (res) {
                var content = res.body;
                if (content.IsSuccess) {
